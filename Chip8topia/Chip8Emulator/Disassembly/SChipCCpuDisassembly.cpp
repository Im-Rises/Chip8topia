...
auto schipc_cpu_disassembly::disassembleOpcode(const uint16 opcode, bool isLowRes) -> std::string
{
    ...
    case 0x0:
    {
        ...
        case 0x00FB: return fmt::format("SCR 0x{:X}", isLowRes ? 2 : 4); // 00FB
        case 0x00FC: return fmt::format("SCL 0x{:X}", isLowRes ? 2 : 4); // 00FC
        ...
        default:
        {
            ...
            {
            case 0x00C0: return fmt::format("SCD 0x{:X}", isLowRes ? nibble1 / 2 : nibble1); // 00CN
